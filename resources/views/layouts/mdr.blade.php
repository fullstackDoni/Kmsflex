...
<div id="wrapper">
    ...
    <div id="sidebar-wrapper" data-simplebar="" data-simplebar-auto-hide="true">
        ...
        <ul class="sidebar-menu do-nicescrol">
            ...
            <li>
                <a href="{{route('moderator.categories.index')}}">
                    <i class="zmdi zmdi-bookmark"></i> <span>Kategoriasy</span>
                </a>
            </li>
            <li>
                <a href="{{route('moderator.comments.index')}}">
                    <i class="zmdi zmdi-bookmark"></i> <span>Pikirler</span>
                </a>
            </li>
            <li>
                <a href="{{route('moderator.genres.index')}}">
                    <i class="zmdi zmdi-archive"></i> <span>Janrlar</span>
                </a>
            </li>
{{--            <li>--}}
{{--                <a href="{{route('moderator.comments.index')}}">--}}
{{--                    <i class="zmdi zmdi-assignment"></i> <span>Pıkırler</span>--}}
{{--                </a>--}}
{{--            </li>--}}
            <li>
                <a href="{{route('moderator.videos.index')}}">
